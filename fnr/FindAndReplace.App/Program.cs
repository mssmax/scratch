...
namespace FindAndReplace.App
{
	...
	public class CommandLineRunner
	{
		...
		public int Run(string[] args)
		{
            ...
            {
                _options.Dir = Environment.CurrentDirectory;
            }
			...
			else
			{
				...
				else
				{
                    foreach (string s in _options.FileMask)
                    {
                        ...
                        replacer.FileMask = s;// _options.FileMask;
